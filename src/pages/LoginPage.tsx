...
// Utilitaire pour fusionner les classes conditionnelles
const cn = (...classes: (string | undefined | null | boolean)[]) => {
  return classes.filter(Boolean).join(' ');
};

const PulsiaLanding = () => {
  const [activeCol, setActiveCol] = useState<number | null>(2); // Colonne 2 active par défaut
  ...
  // État pour la position de la souris (cible) et la position actuelle (pour le lissage)
  ...
  useEffect(() => {
    ...
    const animate = () => {
      ...
      // Mise à jour du DOM directement pour la performance
